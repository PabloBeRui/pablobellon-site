...
`;t.insertAdjacentHTML("beforeend",n)}),document.querySelectorAll(".course-summary").forEach(e=>{e.addEventListener("click",()=>{e.parentElement.classList.toggle("expanded")})})};let p=!1;const j=()=>{const t=document.querySelector("#description-div"),e=document.querySelector("#lang-btn-div"),a=()=>{p?(t.innerHTML=h,e.innerHTML=y):(t.innerHTML=f,e.innerHTML=w),document.querySelector("#lang-btn").addEventListener("click",()=>{p=!p,a()})};a()},M=`<div id="about-me-div-content" class="smooth-fade-in-upward">
